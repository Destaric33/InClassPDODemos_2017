<!-- Page Content  TEMPLATES EDIT CATEGORY-->
<div class="container">
    ...
    <?php
       //1. Must retreieve a url parameter called id
       //var_dump($_GET);
       //exit();
      if(isset($_GET['id']) && is_numeric($_GET['id'])){
          //FOR GET
          // it we get here, we found our id parameter and is numeric
      ...
      //let's connect to the database
       require './includes/config.php';
        ...
        //var_dump($_POST);
           ...
           if(!empty($category)){
               //Build the prepare statement for the UPDATE
            ...
            The category <strong>$category</strong> has been updated!!<br>
            </div>";
